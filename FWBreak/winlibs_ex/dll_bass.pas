...
const
  ...
  BASS_3DALG_LIGHT                  = 3;
  {
    This algorithm gives a good 3D audio effect, and use less CPU than the
...
// Functions
function BASS_SetConfig(option, value: DWORD): DWORD; stdcall; external bass name 'BASS_SetConfig';
function BASS_GetConfig(option: DWORD): DWORD; stdcall; external bass name 'BASS_GetConfig';
function BASS_GetVersion: DWORD; stdcall; external bass name 'BASS_GetVersion';
function BASS_GetDeviceDescription(device: DWORD): PAnsiChar; stdcall; external bass name 'BASS_GetDeviceDescription';
function BASS_ErrorGetCode: DWORD; stdcall; external bass name 'BASS_ErrorGetCode';
function BASS_Init(device: Integer; freq, flags: DWORD; win: HWND; clsid: PGUID): BOOL; stdcall; external bass name 'BASS_Init';
function BASS_SetDevice(device: DWORD): BOOL; stdcall; external bass name 'BASS_SetDevice';
function BASS_GetDevice: DWORD; stdcall; external bass name 'BASS_GetDevice';
function BASS_Free: BOOL; stdcall; external bass name 'BASS_Free';
function BASS_GetDSoundObject(obj: DWORD): Pointer; stdcall; external bass name 'BASS_GetDSoundObject';
function BASS_GetInfo(var info: BASS_INFO): BOOL; stdcall; external bass name 'BASS_GetInfo';
function BASS_Update: BOOL; stdcall; external bass name 'BASS_Update';
function BASS_GetCPU: FLOAT; stdcall; external bass name 'BASS_GetCPU';
function BASS_Start: BOOL; stdcall; external bass name 'BASS_Start';
function BASS_Stop: BOOL; stdcall; external bass name 'BASS_Stop';
function BASS_Pause: BOOL; stdcall; external bass name 'BASS_Pause';
function BASS_SetVolume(volume: DWORD): BOOL; stdcall; external bass name 'BASS_SetVolume';
function BASS_GetVolume: Integer; stdcall; external bass name 'BASS_GetVolume';

function BASS_Set3DFactors(distf, rollf, doppf: FLOAT): BOOL; stdcall; external bass name 'BASS_Set3DFactors';
function BASS_Get3DFactors(var distf, rollf, doppf: FLOAT): BOOL; stdcall; external bass name 'BASS_Get3DFactors';
function BASS_Set3DPosition(var pos, vel, front, top: BASS_3DVECTOR): BOOL; stdcall; external bass name 'BASS_Set3DPosition';
function BASS_Get3DPosition(var pos, vel, front, top: BASS_3DVECTOR): BOOL; stdcall; external bass name 'BASS_Get3DPosition';
procedure BASS_Apply3D; stdcall; external bass name 'BASS_Apply3D';
function BASS_SetEAXParameters(env: Integer; vol, decay, damp: FLOAT): BOOL; stdcall; external bass name 'BASS_SetEAXParameters';
function BASS_GetEAXParameters(var env: DWORD; var vol, decay, damp: FLOAT): BOOL; stdcall; external bass name 'BASS_GetEAXParameters';

function BASS_MusicLoad(mem: BOOL; f: Pointer; offset, length, flags, freq: DWORD): HMUSIC; stdcall; external bass name 'BASS_MusicLoad';
procedure BASS_MusicFree(handle: HMUSIC); stdcall; external bass name 'BASS_MusicFree';
function BASS_MusicGetName(handle: HMUSIC): PAnsiChar; stdcall; external bass name 'BASS_MusicGetName';
function BASS_MusicGetLength(handle: HMUSIC; playlen: BOOL): DWORD; stdcall; external bass name 'BASS_MusicGetLength';
function BASS_MusicPreBuf(handle: HMUSIC): BOOL; stdcall; external bass name 'BASS_MusicPreBuf';
function BASS_MusicPlay(handle: HMUSIC): BOOL; stdcall; external bass name 'BASS_MusicPlay';
function BASS_MusicPlayEx(handle: HMUSIC; pos: DWORD; flags: Integer; reset: BOOL): BOOL; stdcall; external bass name 'BASS_MusicPlayEx';
function BASS_MusicSetAmplify(handle: HMUSIC; amp: DWORD): BOOL; stdcall; external bass name 'BASS_MusicSetAmplify';
function BASS_MusicSetPanSep(handle: HMUSIC; pan: DWORD): BOOL; stdcall; external bass name 'BASS_MusicSetPanSep';
function BASS_MusicSetPositionScaler(handle: HMUSIC; scale: DWORD): BOOL; stdcall; external bass name 'BASS_MusicSetPositionScaler';
function BASS_MusicSetVolume(handle: HMUSIC; chanins,volume: DWORD): BOOL; stdcall; external bass name 'BASS_MusicSetVolume';
function BASS_MusicGetVolume(handle: HMUSIC; chanins: DWORD): Integer; stdcall; external bass name 'BASS_MusicGetVolume';

function BASS_SampleLoad(mem: BOOL; f: Pointer; offset, length, max, flags: DWORD): HSAMPLE; stdcall; external bass name 'BASS_SampleLoad';
function BASS_SampleCreate(length, freq, max, flags: DWORD): Pointer; stdcall; external bass name 'BASS_SampleCreate';
function BASS_SampleCreateDone: HSAMPLE; stdcall; external bass name 'BASS_SampleCreateDone';
procedure BASS_SampleFree(handle: HSAMPLE); stdcall; external bass name 'BASS_SampleFree';
function BASS_SampleGetInfo(handle: HSAMPLE; var info: BASS_SAMPLE): BOOL; stdcall; external bass name 'BASS_SampleGetInfo';
function BASS_SampleSetInfo(handle: HSAMPLE; var info: BASS_SAMPLE): BOOL; stdcall; external bass name 'BASS_SampleSetInfo';
function BASS_SamplePlay(handle: HSAMPLE): HCHANNEL; stdcall; external bass name 'BASS_SamplePlay';
function BASS_SamplePlayEx(handle: HSAMPLE; start: DWORD; freq, volume, pan: Integer; loop: BOOL): HCHANNEL; stdcall; external bass name 'BASS_SamplePlayEx';
function BASS_SamplePlay3D(handle: HSAMPLE; var pos, orient, vel: BASS_3DVECTOR): HCHANNEL; stdcall; external bass name 'BASS_SamplePlay3D';
function BASS_SamplePlay3DEx(handle: HSAMPLE; var pos, orient, vel: BASS_3DVECTOR; start: DWORD; freq, volume: Integer; loop: BOOL): HCHANNEL; stdcall; external bass name 'BASS_SamplePlay3DEx';
function BASS_SampleStop(handle: HSAMPLE): BOOL; stdcall; external bass name 'BASS_SampleStop';

function BASS_StreamCreate(freq, chans, flags: DWORD; proc: Pointer; user: DWORD): HSTREAM; stdcall; external bass name 'BASS_StreamCreate';
function BASS_StreamCreateFile(mem: BOOL; f: Pointer; offset, length, flags: DWORD): HSTREAM; stdcall; external bass name 'BASS_StreamCreateFile';
function BASS_StreamCreateURL(URL: PAnsiChar; offset: DWORD; flags: DWORD; proc:DOWNLOADPROC; user: DWORD):HSTREAM; stdcall; external bass name 'BASS_StreamCreateURL';
function BASS_StreamCreateFileUser(buffered: BOOL; flags: DWORD; proc:STREAMFILEPROC; user: DWORD): HSTREAM; stdcall; external bass name 'BASS_StreamCreateFileUser';
procedure BASS_StreamFree(handle: HSTREAM); stdcall; external bass name 'BASS_StreamFree';
function BASS_StreamGetLength(handle: HSTREAM): QWORD; stdcall; external bass name 'BASS_StreamGetLength';
function BASS_StreamGetTags(handle: HSTREAM; tags : DWORD): PAnsiChar; stdcall; external bass name 'BASS_StreamGetTags';
function BASS_StreamPreBuf(handle: HMUSIC): BOOL; stdcall; external bass name 'BASS_StreamPreBuf';
function BASS_StreamPlay(handle: HSTREAM; flush: BOOL; flags: DWORD): BOOL; stdcall; external bass name 'BASS_StreamPlay';
function BASS_StreamGetFilePosition(handle: HSTREAM; mode: DWORD) : DWORD; stdcall; external bass name 'BASS_StreamGetFilePosition';

function BASS_RecordGetDeviceDescription(devnum: DWORD): PAnsiChar; stdcall; external bass name 'BASS_RecordGetDeviceDescription';
function BASS_RecordInit(device: Integer): BOOL; stdcall; external bass name 'BASS_RecordInit';
function BASS_RecordSetDevice(device: DWORD): BOOL; stdcall; external bass name 'BASS_RecordSetDevice';
function BASS_RecordGetDevice: DWORD; stdcall; external bass name 'BASS_RecordGetDevice';
function BASS_RecordFree: BOOL; stdcall; external bass name 'BASS_RecordFree';
function BASS_RecordGetInfo(var info: BASS_RECORDINFO): BOOL; stdcall; external bass name 'BASS_RecordGetInfo';
function BASS_RecordGetInputName(input: DWORD): PAnsiChar; stdcall; external bass name 'BASS_RecordGetInputName';
function BASS_RecordSetInput(input: DWORD; setting: DWORD): BOOL; stdcall; external bass name 'BASS_RecordSetInput';
function BASS_RecordGetInput(input: DWORD): DWORD; stdcall; external bass name 'BASS_RecordGetInput';
function BASS_RecordStart(freq,flags: DWORD; proc:RECORDPROC; user: DWORD):HRECORD; stdcall; external bass name 'BASS_RecordStart';

function BASS_ChannelBytes2Seconds(handle: DWORD; pos: QWORD): FLOAT; stdcall;external bass name 'BASS_ChannelBytes2Seconds';
function BASS_ChannelSeconds2Bytes(handle: DWORD; pos: FLOAT): QWORD; stdcall;external bass name 'BASS_ChannelSeconds2Bytes';
function BASS_ChannelGetDevice(handle: DWORD): DWORD; stdcall; external bass name 'BASS_ChannelGetDevice';
function BASS_ChannelIsActive(handle: DWORD): DWORD; stdcall;external bass name 'BASS_ChannelIsActive';
function BASS_ChannelGetInfo(handle: DWORD; var info:BASS_CHANNELINFO): BOOL; stdcall; external bass name 'BASS_ChannelGetInfo';
function BASS_ChannelStop(handle: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelStop';
function BASS_ChannelPause(handle: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelPause';
function BASS_ChannelResume(handle: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelResume';
function BASS_ChannelSetAttributes(handle: DWORD; freq, volume, pan: Integer): BOOL; stdcall; external bass name 'BASS_ChannelSetAttributes';
function BASS_ChannelGetAttributes(handle: DWORD; var freq, volume: DWORD; var pan: Integer): BOOL; stdcall; external bass name 'BASS_ChannelGetAttributes';
function BASS_ChannelSlideAttributes(handle: DWORD; freq, volume, pan: Integer; time: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelSlideAttributes';
function BASS_ChannelIsSliding(handle: DWORD): DWORD; stdcall;external bass name 'BASS_ChannelIsSliding';
function BASS_ChannelSet3DAttributes(handle: DWORD; mode: Integer; min, max: FLOAT; iangle, oangle, outvol: Integer): BOOL; stdcall; external bass name 'BASS_ChannelSet3DAttributes';
function BASS_ChannelGet3DAttributes(handle: DWORD; var mode: DWORD; var min, max: FLOAT; var iangle, oangle, outvol: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelGet3DAttributes';
function BASS_ChannelSet3DPosition(handle: DWORD; var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall; external bass name 'BASS_ChannelSet3DPosition';
function BASS_ChannelGet3DPosition(handle: DWORD; var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall; external bass name 'BASS_ChannelGet3DPosition';
function BASS_ChannelSetPosition(handle: DWORD; pos: QWORD): BOOL; stdcall; external bass name 'BASS_ChannelSetPosition';
function BASS_ChannelGetPosition(handle: DWORD): QWORD; stdcall; external bass name 'BASS_ChannelGetPosition';
function BASS_ChannelGetLevel(handle: DWORD): DWORD; stdcall; external bass name 'BASS_ChannelGetLevel';
function BASS_ChannelGetData(handle: DWORD; buffer: Pointer; length: DWORD): DWORD; stdcall; external bass name 'BASS_ChannelGetData';
function BASS_ChannelSetSync(handle: DWORD; stype: DWORD; param: QWORD; proc: SYNCPROC; user: DWORD): HSYNC; stdcall; external bass name 'BASS_ChannelSetSync';
function BASS_ChannelRemoveSync(handle: DWORD; sync: HSYNC): BOOL; stdcall; external bass name 'BASS_ChannelRemoveSync';
function BASS_ChannelSetDSP(handle: DWORD; proc: DSPPROC; user: DWORD; priority: Integer): HDSP; stdcall; external bass name 'BASS_ChannelSetDSP';
function BASS_ChannelRemoveDSP(handle: DWORD; dsp: HDSP): BOOL; stdcall; external bass name 'BASS_ChannelRemoveDSP';
function BASS_ChannelSetEAXMix(handle: DWORD; mix: FLOAT): BOOL; stdcall; external bass name 'BASS_ChannelSetEAXMix';
function BASS_ChannelGetEAXMix(handle: DWORD; var mix: FLOAT): BOOL; stdcall; external bass name 'BASS_ChannelGetEAXMix';
function BASS_ChannelSetLink(handle, chan: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelSetLink';
function BASS_ChannelRemoveLink(handle, chan: DWORD): BOOL; stdcall; external bass name 'BASS_ChannelRemoveLink';
function BASS_ChannelSetFX(handle, etype: DWORD): HFX; stdcall; external bass name 'BASS_ChannelSetFX';
function BASS_ChannelRemoveFX(handle: DWORD; fx: HFX): BOOL; stdcall; external bass name 'BASS_ChannelRemoveFX';

function BASS_FXSetParameters(handle: HFX; par: Pointer): BOOL; stdcall; external bass name 'BASS_FXSetParameters';
function BASS_FXGetParameters(handle: HFX; par: Pointer): BOOL; stdcall; external bass name 'BASS_FXGetParameters';
