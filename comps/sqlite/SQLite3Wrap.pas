...
type
  ...
  public
    ...
    function BlobOpenStream(const Table, Column: WideString; const RowID: Int64; const WriteAccess: Boolean = True; BusyMode: TSQLite3BusyMode = bmAuto): TSQLite3BlobStream;
...
function TSQLite3Database.BlobOpenStream(const Table, Column: WideString;
  const RowID: Int64; const WriteAccess: Boolean; BusyMode: TSQLite3BusyMode): TSQLite3BlobStream;
begin
...
begin
  ...
  FOwnerDatabase.Check(
    _sqlite3_blob_open(FOwnerDatabase.FHandle, 'main', PAnsiChar(StrToUTF8(FTable)),
